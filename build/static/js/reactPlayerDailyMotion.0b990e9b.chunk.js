  ...
  [596],
  {
    4303: (e, t, r) => {
          ...
          if ((t && "object" === typeof t) || "function" === typeof t)
            for (let o of i(t))
              p.call(e, o) ||
                ...
                s(e, o, {
                  get: () => t[o],
                  enumerable: !(a = n(t, o)) || a.enumerable,
                });
          return e;
        },
        h = (e, t, r) => (
      ...
      ((e, t) => {
        ...
        (e.exports = ((a = c), u(s({}, "__esModule", { value: !0 }), a)));
      var d = ((e, t, r) => (
          (r = null != e ? o(l(e)) : {}),
          u(
            !t && e && e.__esModule
      ...
      class f extends d.Component {
        ...
        load(e) {
          const { controls: t, config: r, onError: a, playing: o } = this.props,
            [, s] = e.match(m.MATCH_URL_DAILYMOTION);
          this.player
            ? this.player.load(s, {
            ...
            : (0, y.getSDK)(
                ...
                const n = o.player;
                this.player = new n(this.container, {
                  width: "100%",
                  height: "100%",
                  video: s,
                  params: {
      ...
      h(f, "displayName", "DailyMotion"),
        h(f, "canPlay", m.canPlay.dailymotion),
        h(f, "loopOnEnded", !0);
    },
  },
]);
//# sourceMappingURL=reactPlayerDailyMotion.0b990e9b.chunk.js.map
