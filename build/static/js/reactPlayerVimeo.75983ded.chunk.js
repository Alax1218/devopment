  ...
  [743],
  {
    7600: (e, t, r) => {
          ...
          if ((t && "object" === typeof t) || "function" === typeof t)
            for (let o of n(t))
              p.call(e, o) ||
                ...
                a(e, o, {
                  get: () => t[o],
                  enumerable: !(s = i(t, o)) || s.enumerable,
                });
          return e;
        },
        u = (e, t, r) => (
      ...
      ((e, t) => {
        ...
        (e.exports = ((s = c), h(a({}, "__esModule", { value: !0 }), s)));
      var d = ((e, t, r) => (
          (r = null != e ? o(l(e)) : {}),
          h(
            !t && e && e.__esModule
        ...
        y = r(135),
        f = r(365);
      const m = (e) => e.replace("/manage/videos", "");
        ...
        load(e) {
          (this.duration = null),
            (0, y.getSDK)(
              ...
              const { playerOptions: r, title: s } = this.props.config;
              (this.player = new t.Player(this.container, {
                ...
                this.player
                  .ready()
                  .then(() => {
                    const e = this.container.querySelector("iframe");
                    (e.style.width = "100%"),
                      (e.style.height = "100%"),
                      s && (e.title = s);
                  })
...
//# sourceMappingURL=reactPlayerVimeo.75983ded.chunk.js.map
