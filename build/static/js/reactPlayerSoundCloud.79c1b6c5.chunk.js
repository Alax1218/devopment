  ...
  [125],
  {
    1801: (e, t, r) => {
      ...
      ((e, t) => {
        ...
        (e.exports = ((o = d), p(a({}, "__esModule", { value: !0 }), o)));
      var c = ((e, t, r) => (
          (r = null != e ? s(n(e)) : {}),
          p(
            !t && e && e.__esModule
      ...
      class f extends c.Component {
        ...
        load(e, t) {
          (0, y.getSDK)("https://w.soundcloud.com/player/api.js", "SC").then(
            (r) => {
              ...
              t ||
                ...
                this.player.bind(i, () => this.props.onEnded()),
                this.player.bind(l, (e) => this.props.onError(e))),
                this.player.load(e, {
      ...
      h(f, "displayName", "SoundCloud"),
        h(f, "canPlay", m.canPlay.soundcloud),
        h(f, "loopOnEnded", !0);
    },
  },
]);
//# sourceMappingURL=reactPlayerSoundCloud.79c1b6c5.chunk.js.map
