  ...
  [121],
  {
    4793: (e, t, r) => {
          ...
          if ((t && "object" === typeof t) || "function" === typeof t)
            for (let a of i(t))
              p.call(e, a) ||
                ...
                l(e, a, {
                  get: () => t[a],
                  enumerable: !(s = o(t, a)) || s.enumerable,
                });
          return e;
        },
        c = (e, t, r) => (
      ...
      ((e, t) => {
        ...
        (e.exports = ((s = h), u(l({}, "__esModule", { value: !0 }), s)));
      var y = ((e, t, r) => (
          (r = null != e ? a(n(e)) : {}),
          u(
            !t && e && e.__esModule
        ...
        d = r(135),
        b = r(365);
      const f = "https://connect.facebook.net/en_US/sdk.js",
        m = "fbAsyncInit";
      class g extends y.Component {
          ...
          super(...arguments),
            ...
            c(
              ...
              this.props.config.playerId ||
                "".concat("facebook-player-").concat((0, d.randomString)())
            ),
            c(this, "mute", () => {
        ...
        load(e, t) {
          t
            ? (0, d.getSDK)(f, "FB", m).then((e) => e.XFBML.parse())
            : (0, d.getSDK)(f, "FB", m).then((e) => {
                e.init({
      ...
      c(g, "displayName", "Facebook"),
        c(g, "canPlay", b.canPlay.facebook),
        c(g, "loopOnEnded", !0);
    },
  },
]);
//# sourceMappingURL=reactPlayerFacebook.fb3c580a.chunk.js.map
