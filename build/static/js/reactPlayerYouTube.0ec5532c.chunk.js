  ...
  [439],
  {
    8322: (e, t, a) => {
      ...
      ((e, t) => {
        ...
        (e.exports = ((s = u), y(l({}, "__esModule", { value: !0 }), s)));
      var h = ((e, t, a) => (
          (a = null != e ? o(i(e)) : {}),
          y(
            !t && e && e.__esModule
        ...
        d = a(135),
        P = a(365);
      const g = /[?&](?:list|channel)=([a-zA-Z0-9_-]+)/,
        m = /user\/([a-zA-Z0-9_-]+)\/?/,
      ...
      class b extends h.Component {
          ...
          super(...arguments),
            ...
            c(this, "onStateChange", (e) => {
              ...
              if (
                ...
                i && !e && (p.start ? this.seekTo(p.start) : this.play()), r();
              }
              t === g && n();
            }),
            c(this, "mute", () => {
        ...
        getID(e) {
          return !e || e instanceof Array || g.test(e)
            ? null
        ...
        load(e, t) {
          const {
            ...
            { playerVars: p, embedOptions: y } = n,
            c = this.getID(e);
          if (t)
            return g.test(e) || m.test(e) || e instanceof Array
          ...
          (0, d.getSDK)(
            ...
            this.container &&
              (this.player = new t.Player(this.container, {
                ...
                events: {
                  onReady: () => {
                    r && this.player.setLoop(!0), this.props.onReady();
                  },
...
//# sourceMappingURL=reactPlayerYouTube.0ec5532c.chunk.js.map
